...
public class HttpClientUtil {
     ...
     * @throws Exception
     */
    public static String deleteRequest(String url, String reqBodyStr, Map<String, Object> headerMap) throws Exception {
     ...
     * @throws Exception
     */
    public static String putRequest(String url, String reqBodyStr, Map<String, Object> headerMap) throws Exception {
