...
public interface NodeCycleMapper extends Mapper<NodeCycle> {
    ...
    int updateLastCycleProportion(@Param("publicKey") String publicKey, @Param("cycle") Integer cycle, @Param("name") String name, @Param("nodeProportionT2") String nodeProportionT2, @Param("userProportionT2") String userProportionT2, @Param("bonusOng") BigDecimal bonusOng);
